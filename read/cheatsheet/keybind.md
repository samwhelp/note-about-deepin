...
| 設定檔 |
| ----- |
| [~/.config/kglobalshortcutsrc](https://github.com/samwhelp/deepin-adjustment/blob/main/prototype/deepin-25/deepin-config/session-kwin/locale/en_us/Deepin-Dark/asset/overlay/etc/skel/.config/kglobalshortcutsrc#L45) |
| [~/.config/deepin/dde-daemon/keybinding/custom.ini](https://github.com/samwhelp/deepin-adjustment/blob/main/prototype/deepin-25/deepin-config/session-kwin/locale/en_us/Deepin-Dark/asset/overlay/etc/skel/.config/deepin/dde-daemon/keybinding/custom.ini) |

> 有一部份是透過「[gsettings](https://github.com/samwhelp/deepin-adjustment/blob/main/prototype/deepin-25/deepin-config/session-kwin/locale/en_us/Deepin-Dark/config-install.sh#L112)」的機制。
...
| 相關連結 |
| ------- |
| [鍵盤按鍵綁定](https://samwhelp.github.io/note-about-deepin/read/config/keybind.html) |
...
| [hotkey-tips](https://github.com/samwhelp/deepin-adjustment/tree/main/project/gen/hotkey-tips) |
| ----------- |
| [hotkey-tips.md](https://github.com/samwhelp/deepin-adjustment/blob/main/project/gen/hotkey-tips/dist/locale/zh_TW/hotkey-tips.md) |
| [hotkey-tips.tsv](https://github.com/samwhelp/deepin-adjustment/blob/main/project/gen/hotkey-tips/dist/locale/zh_TW/hotkey-tips.tsv) |
| [hotkey-tips.sh](https://github.com/samwhelp/deepin-adjustment/blob/main/project/gen/hotkey-tips/dist/locale/zh_TW/hotkey-tips.sh) |
